...
#ifndef OPENGLPROJECT_VERTEX_ARRAY_BUFFER_H
#define OPENGLPROJECT_VERTEX_ARRAY_BUFFER_H

#include <vector>
#include <glad/glad.h>
#include "gl_debug.h"

//GLuint generate_buffer_id()
//{
//    GLuint id;
...
public:
    ...
    void push(unsigned int type, VertexBuffer vbo, unsigned int count, GLboolean normalize);
...
#endif //OPENGLPROJECT_VERTEX_ARRAY_BUFFER_H
